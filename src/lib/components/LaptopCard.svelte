...
<a href="/laptops/{laptop.id}" class="block rounded-lg border bg-white p-4 transition hover:shadow-md">
  ...
  <div class="mt-2 text-right text-sm font-medium text-slate-700">Skor {result.total}</div>
</a>
