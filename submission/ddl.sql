...
-- F3. fn_score_breakdown — breakdown skor per faktor dalam JSON
--   Mengembalikan object dengan keys: cpu, ram, storage, condition, warranty, age, price, total
--   Setiap faktor (kecuali total) adalah object {points, max}
